...
public class Create : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i =0; i < numSphere; i++){
            ...
            initPos[i] = new Vector3(Mathf.Sqrt(2) * Mathf.Pow(Mathf.Sin(i * 2 * Mathf.PI / numSphere), 3), Mathf.Pow(-Mathf.Cos(i * 2 * Mathf.PI / numSphere), 3) - Mathf.Pow(Mathf.Cos(i * 2 * Mathf.PI / numSphere), 2) + 2 * Mathf.Cos(i * 2 * Mathf.PI / numSphere), 10f);
